...
BLOG_AUTHOR = "Zohra Rezgui"  # (translatable)
BLOG_TITLE = "Zohra Rezgui"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://zohrarezgui.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://zohrarezgui.github.io/"
BLOG_EMAIL = "zohra.rzg@gmail.com"
BLOG_DESCRIPTION = "Zohra Rezgui's Personal Website"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ( "/categories/cat_stuff-i-did", "Stuff I did"),
...
FAVICONS = (
     ("icon", "/images/venus_planet.png", "16x16"),
